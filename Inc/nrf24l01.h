...
/* Pins configuration */
#define NRF24L01_CE_LOW            HAL_GPIO_WritePin(GPIOB, SPI_CE_Pin, GPIO_PIN_RESET)
#define NRF24L01_CE_HIGH           HAL_GPIO_WritePin(GPIOB, SPI_CE_Pin, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW           HAL_GPIO_WritePin(GPIOA, SPI_CSN_Pin, GPIO_PIN_RESET)
#define NRF24L01_CSN_HIGH          HAL_GPIO_WritePin(GPIOA, SPI_CSN_Pin, GPIO_PIN_SET)
    /*
